#ifndef _NOKIA_5110_LCD_
#define _NOKIA_5110_LCD_
/*
...
#define PIN_RESET 2 //Pin 4 on LCD
#define PIN_DC    0 //Pin 5 on LCD
#define PIN_SDIN  15 //Pin 6 on LCD
...
const char* ssid     = "loongson.ddns.cfido.com";     // insert your SSID
const char* password = "63508790"; // insert your password

const char* host = "192.168.12.7";
String url = "/video/test.php";
...
void setup() {
  ...
  LCDClear();
  Serial.println("LCDBitmap()");
  LCDBitmap(bitcoin); // display Bitcoin Logo
  delay(3000);

  LCDClear();
  gotoXY(0, 4);
  LCDPrint("www.wf163.com");
  delay(13000);
